  ...
  return (
    <div className="pt-28 pb-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4 pt-2">
            <div className="p-4 rounded-2xl bg-white border border-slate-200 shadow-sm">
              ...
              <span className="text-xs font-semibold text-slate-600">Happy Clients</span>
            </div>
            <div className="p-4 rounded-2xl bg-white border border-slate-200 shadow-sm">
              <span className="font-heading text-3xl font-black text-ag-gold block">100%</span>
              <span className="text-xs font-semibold text-slate-600">Spotless Guarantee</span>
            </div>
          </div>
        </div>

        <div className="relative rounded-3xl overflow-hidden h-96 border border-slate-200 shadow-xl">
          <img
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="glass-panel p-8 rounded-3xl space-y-4 border border-slate-200/80 shadow-md">
          <div className="w-12 h-12 rounded-xl bg-red-100 text-ag-cyan flex items-center justify-center">
            <Car className="w-6 h-6" />
          </div>
          <h3 className="font-heading text-xl font-bold text-slate-900">Curated Fleet</h3>
        ...
        <div className="glass-panel p-8 rounded-3xl space-y-4 border border-slate-200/80 shadow-md">
          <div className="w-12 h-12 rounded-xl bg-amber-100 text-ag-gold flex items-center justify-center">
            <Sparkles className="w-6 h-6" />
          </div>
          <h3 className="font-heading text-xl font-bold text-slate-900">Master Detailing</h3>
          <p className="text-xs text-slate-600 leading-relaxed font-normal">
        ...
        <div className="glass-panel p-8 rounded-3xl space-y-4 border border-slate-200/80 shadow-md">
          ...
          <h3 className="font-heading text-xl font-bold text-slate-900">Total Transparency</h3>
          <p className="text-xs text-slate-600 leading-relaxed font-normal">
