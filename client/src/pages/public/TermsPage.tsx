    ...
    <div className="pt-28 pb-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 text-slate-700 text-sm leading-relaxed">
      ...
      <div className="glass-panel p-8 rounded-3xl space-y-6 border border-slate-200 shadow-md">
        <section className="space-y-2">
          <h2 className="text-lg font-bold text-slate-900">1. Driver Eligibility & Licensing</h2>
        ...
        <section className="space-y-2">
          <h2 className="text-lg font-bold text-slate-900">2. Insurance & Security Deposit</h2>
          <p className="text-slate-700">
        ...
        <section className="space-y-2">
          <h2 className="text-lg font-bold text-slate-900">3. Car Washing & Detailing Warranties</h2>
          <p className="text-slate-700">
        ...
        <section className="space-y-2">
          <h2 className="text-lg font-bold text-slate-900">4. Cancellations & Refunds</h2>
          <p className="text-slate-700">
